...
use ggez::{
    ...
    graphics::{self, GlBackendSpec, ImageGeneric, Mesh},
    mint::Point2,
};
...
impl Rgbcolor {
    pub fn ggez_color(&self) -> graphics::Color {
        return match self {
            Rgbcolor::Bg => graphics::Color {
                r: 0.39,
                g: 0.78,
                b: 0.2,
                a: 1.,
            },
            Rgbcolor::Border => graphics::Color {
                r: 0.39,
                g: 0.39,
                b: 0.39,
                a: 1.,
            },
            Rgbcolor::Field => graphics::Color {
                r: 0.88,
                g: 0.88,
                b: 0.88,
                a: 1.,
            },
            Rgbcolor::Selection => graphics::Color {
                r: 0.08,
                g: 0.18,
                b: 0.2,
                a: 1.,
...
const fn generate_coords() -> [Point2<f32>; FIELD_AREA] {
    ...
    while index < FIELD_AREA {
        coordinates[index] = Point2 {
            x: ((index % GAPS) * GEM_SCALE) as f32,
...
impl Sounds {
    pub fn new(context: &mut Context) -> GameResult<Self> {
        return Ok(Sounds {
            gem_sound1: Source::new(context, "/Sounds/Gem_sound.mp3")?,
